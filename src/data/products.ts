...
export const categories = [
  ...
  { slug: 'jubba', name: 'Jubba / Thobe', description: 'Tailored Islamic luxury', group: 'Mens' },
  { slug: 'panjabi', name: 'Panjabi', description: 'Refined ethnic fashion', group: 'Mens' },
  { slug: 'tshirts', name: 'T-Shirts', description: 'Premium daily essentials', group: 'Mens' },
  { slug: 'polo', name: 'Polo Shirts', description: 'Refined casual classics', group: 'Mens' },
  { slug: 'shirts', name: 'Shirts', description: 'Tailored button-downs', group: 'Mens' },
  { slug: 'pants', name: 'Pants', description: 'Modern tailored trousers', group: 'Mens' },
  { slug: 'hoodies', name: 'Hoodies', description: 'Elevated everyday warmth', group: 'Mens' },
